        ...
        chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
            ...
            if (currentTab && currentTab.url && (currentTab.url.startsWith("http://") || currentTab.url.startsWith("https://") || currentTab.url.startsWith("file://"))) {
                chrome.scripting.executeScript({
                    ...
                    files: ["lib/purify.min.js", "lib/turndown.js", "lib/turndown-plugin-gfm.js", "lib/marked.min.js", "tsv-detector.js", "grid-detector.js", "equivalents.js", "pipeline.js", "content.js"]
                });
            } else {
